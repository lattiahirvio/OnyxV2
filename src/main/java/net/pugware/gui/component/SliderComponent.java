...
import net.pugware.util.MathUtils;
...
public class SliderComponent extends Component {
    ...
    private void renderSlider(MatrixStack matrices) {
        double r = ClickGuiSettings.class.cast(Pugware.INSTANCE.getModuleManager().getModule(ClickGuiSettings.class)).getHudColorRed();
        double g = ClickGuiSettings.class.cast(Pugware.INSTANCE.getModuleManager().getModule(ClickGuiSettings.class)).getHudColorGreen();
        double b = ClickGuiSettings.class.cast(Pugware.INSTANCE.getModuleManager().getModule(ClickGuiSettings.class)).getHudColorBlue();
