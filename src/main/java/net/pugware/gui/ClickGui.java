...
public class ClickGui {
    ...
    public void init() {
        ...
        for (Category category : Category.values()) {
            Window window = new Window(this, x, 25, 125, Pugware.INSTANCE.getModuleManager().getNumberOfCategory(category)*20+20);
        ...
        for (Module module : Pugware.INSTANCE.getModuleManager().getModules()) {
