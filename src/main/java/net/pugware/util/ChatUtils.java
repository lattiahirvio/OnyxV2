...
public enum ChatUtils {
    ...
    public static void log(String message) {
        LogManager.getLogger().info("[Pugware] {}", message.replaceAll("\r", "\\\\r").replaceAll("\n", "\\\\n"));
    }
    ...
    public static String replaceName(String string) {
        if (string != null && Pugware.INSTANCE.getModuleManager().getModule(NameProtect.class).isEnabled()) {
