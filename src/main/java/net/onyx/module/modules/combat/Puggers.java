...
implements PlayerTickListener, ItemUseListener {
    ...
    private final IntegerSetting BreakTwice = IntegerSetting.Builder.newInstance().setName("Crystals").setDescription("Breaking the crystal twice").setModule(this).setValue(20).setMin(1).setMax(50).setAvailability(() -> true).build();
